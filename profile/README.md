...
[Planning drawing validator](https://github.com/i-dot-ai/planning-drawing-validator) | An application for validating planning drawings, such as floor plans, using [VLM](https://www.nvidia.com/en-gb/glossary/vision-language-models/) techniques and up-to-date guidance. |
